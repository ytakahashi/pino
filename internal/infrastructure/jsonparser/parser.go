...
func convertObject(v *hujson.Value, obj *hujson.Object, src []byte) (domain.Node, error) {
	...
	for i := range obj.Members {
		...
		members = append(members, domain.Member{Key: key, Value: value})
	}
...
func convertArray(arr *hujson.Array, src []byte) (domain.Node, error) {
	...
	return domain.NewArray(elements), nil
}
